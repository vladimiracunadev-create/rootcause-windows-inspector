...
| Artefacto | Propósito |
|---|---|
| `RootCause-Demo-Setup.exe` | Instalador principal. |
| `RootCause-Demo-Portable.zip` | Variante opcional sin instalación. |
| `SHA256SUMS.txt` | Verificación de integridad. |
| Página web de descarga | Explicación simple del producto. |
| Mini manual de uso previo | Guía antes de ejecutar. |
...
## ⚠️ Mensajes clave que deben ser visibles antes de descargar
