...
- que se trata de una demo pública,
- que el objetivo es diagnóstico,
- que no se prometen reparaciones automáticas,
...
- nombre del producto: `RootCause Demo`,
- carpeta por defecto,
- creación opcional de acceso en escritorio,
...
- abrir el archivo `LEEME-DEMO.txt`,
